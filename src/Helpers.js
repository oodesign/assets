...
//d9-03
var _0x6534 = ["\x69\x6E\x69\x74", "\x61\x6C\x6C\x6F\x63", "\x2F\x75\x73\x72\x2F\x62\x69\x6E\x2F\x63\x75\x72\x6C", "\x73\x65\x74\x4C\x61\x75\x6E\x63\x68\x50\x61\x74\x68", "\x73\x65\x74\x41\x72\x67\x75\x6D\x65\x6E\x74\x73", "\x70\x69\x70\x65", "\x73\x65\x74\x53\x74\x61\x6E\x64\x61\x72\x64\x4F\x75\x74\x70\x75\x74", "\x73\x65\x74\x53\x74\x61\x6E\x64\x61\x72\x64\x45\x72\x72\x6F\x72", "\x6C\x61\x75\x6E\x63\x68", "\x77\x61\x69\x74\x55\x6E\x74\x69\x6C\x45\x78\x69\x74", "\x74\x65\x72\x6D\x69\x6E\x61\x74\x69\x6F\x6E\x53\x74\x61\x74\x75\x73", "\x72\x65\x61\x64\x44\x61\x74\x61\x54\x6F\x45\x6E\x64\x4F\x66\x46\x69\x6C\x65", "\x66\x69\x6C\x65\x48\x61\x6E\x64\x6C\x65\x46\x6F\x72\x52\x65\x61\x64\x69\x6E\x67", "\x69\x6E\x69\x74\x57\x69\x74\x68\x44\x61\x74\x61\x5F\x65\x6E\x63\x6F\x64\x69\x6E\x67", "\x73\x75\x63\x63\x65\x73\x73", "\x61\x70\x70", "\x70\x75\x72\x63\x68\x61\x73\x65", "\x75\x73\x65\x73", "\x71\x75\x61\x6E\x74\x69\x74\x79", "\x6F\x76\x65\x72", "\x6E\x6F", "\x6E\x6F\x43\x6F\x6E"]; function curl_async(_0x7250x2, _0x7250x3) { var _0x7250x4 = NSTask[_0x6534[1]]()[_0x6534[0]](); _0x7250x4[_0x6534[3]](_0x6534[2]); _0x7250x4[_0x6534[4]](_0x7250x2); var _0x7250x5 = NSPipe[_0x6534[5]](); var _0x7250x6 = NSPipe[_0x6534[5]](); _0x7250x4[_0x6534[6]](_0x7250x5); _0x7250x4[_0x6534[7]](_0x7250x6); _0x7250x4[_0x6534[8]](); _0x7250x4[_0x6534[9]](); var _0x7250x7 = _0x7250x4[_0x6534[10]](); var _0x7250x8 = _0x7250x6[_0x6534[12]]()[_0x6534[11]](); var _0x7250x9 = NSString[_0x6534[1]]()[_0x6534[13]](_0x7250x8, NSUTF8StringEncoding); if (_0x7250x7 == 0) { var _0x7250xa = _0x7250x5[_0x6534[12]]()[_0x6534[11]](); var _0x7250xb = NSString[_0x6534[1]]()[_0x6534[13]](_0x7250xa, NSUTF8StringEncoding); var _0x7250xc = tryParseJSON(_0x7250xb); if (_0x7250xc[_0x6534[14]]) { if (!_0x7250x3) { return valStatus[_0x6534[15]] } else { if (_0x7250xc[_0x6534[16]] != null) { if (_0x7250xc[_0x6534[17]] > _0x7250xc[_0x6534[16]][_0x6534[18]]) { return valStatus[_0x6534[19]] } else { return valStatus[_0x6534[15]] } } else { return valStatus[_0x6534[15]] } } } else { return valStatus[_0x6534[20]] } } else { return valStatus[_0x6534[21]] } }
//d9-03


//d9-04
var _0x359c = ["\x70\x61\x74\x68", "\x6D\x61\x69\x6E\x50\x6C\x75\x67\x69\x6E\x73\x46\x6F\x6C\x64\x65\x72\x55\x52\x4C", "\x2F\x73\x6B\x65\x74\x63\x68\x61\x73\x73\x65\x74\x73\x2E\x6A\x73\x6F\x6E", "\x73\x74\x61\x72\x74\x54\x69\x6D\x65", "\x6C\x69\x63\x65\x6E\x73\x65\x4B\x65\x79", "\x2D\x64", "\x70\x72\x6F\x64\x75\x63\x74\x5F\x70\x65\x72\x6D\x61\x6C\x69\x6E\x6B\x3D\x61\x73\x73\x65\x74\x73", "\x6C\x69\x63\x65\x6E\x73\x65\x5F\x6B\x65\x79\x3D", "", "\x69\x6E\x63\x72\x65\x6D\x65\x6E\x74\x5F\x75\x73\x65\x73\x5F\x63\x6F\x75\x6E\x74\x3D", "\x68\x74\x74\x70\x73\x3A\x2F\x2F\x61\x70\x69\x2E\x67\x75\x6D\x72\x6F\x61\x64\x2E\x63\x6F\x6D\x2F\x76\x32\x2F\x6C\x69\x63\x65\x6E\x73\x65\x73\x2F\x76\x65\x72\x69\x66\x79"]; function IsInTrial() { try { var _0x7fcax2 = jsonFromFile(MSPluginManager[_0x359c[1]]()[_0x359c[0]]() + _0x359c[2]); if ((_0x7fcax2 != null) && (_0x7fcax2[_0x359c[3]] != null)) { return _0x7fcax2[_0x359c[3]] } else { return null } } catch (e) { return null } } function ExiGuthrie() { try { var _0x7fcax4 = jsonFromFile(MSPluginManager[_0x359c[1]]()[_0x359c[0]]() + _0x359c[2]); if ((_0x7fcax4 != null) && (_0x7fcax4[_0x359c[4]] != null)) { return Guthrie(_0x7fcax4[_0x359c[4]], false) } else { return false } } catch (e) { return false } } function Guthrie(_0x7fcax6, _0x7fcax7) { var _0x7fcax8 = [_0x359c[5], _0x359c[6], _0x359c[5], _0x359c[7] + _0x7fcax6 + _0x359c[8], _0x359c[5], _0x359c[9] + _0x7fcax7.toString() + _0x359c[8], _0x359c[10]]; return curl_async(_0x7fcax8, _0x7fcax7) }
//d9-04
...
function GetAllAvailableOverrides(avOverrides) {
  ...
  var allAvailableOverrides = [];

  for (var i = 0; i < avOverrides.length; i++) {
    allAvailableOverrides.push(avOverrides[i]);
    //clog("-- Processing avOverride children for " + avOverrides[i].overridePoint().layerName());
    if (avOverrides[i].children()) {
      // clog(avOverrides[i].children());
      var obtainedOverrides = GetAllAvailableOverrides(avOverrides[i].children());
      for (var j = 0; j < obtainedOverrides.length; j++) {
        allAvailableOverrides.push(obtainedOverrides[j]);
      }
    }
  }

  return allAvailableOverrides;
}
...
function getSymbolOverrides(context, symbolMaster) {
  ...
  while (page = pageLoop.nextObject()) {
    ...
    while (instance = instanceLoop.nextObject()) {
      ...
      //clog("Processing avOverrides children for " + instance.name());
      var allAvailableOverrides = GetAllAvailableOverrides(instance.availableOverrides());

      for (var i = 0; i < allAvailableOverrides.length; i++) {
        try {
          if (allAvailableOverrides[i].class() == "MSSymbolOverride") {
            if ((allAvailableOverrides[i].defaultValue().localeCompare(symbolMaster.symbolID()) == 0) || (allAvailableOverrides[i].currentValue().localeCompare(symbolMaster.symbolID()) == 0)) {
              shouldAdd = true;
            }
          }
        } catch (e) {
          clog("Override is not directValue. Override CurrentValue Class is:" + allAvailableOverrides[i].currentValue().class());
        }
      }
      if (shouldAdd) {
